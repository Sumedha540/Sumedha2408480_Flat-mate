...
import { EyeIcon, EyeOffIcon, XIcon, MailIcon, LockIcon, Users, Home } from 'lucide-react';
...
export function LoginModal({
  ...
  const handleGoogleLogin = () => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      login('google_user@example.com', role as UserRole);
      setIsLoading(false);
      toast.success('Welcome back!', {
        icon: '👋',
        duration: 2000
      ...
      {isOpen && <>
        ...
        damping: 30
          ...
          delay: 0.1
            ...
            delay: 0.25
                ...
                <div className="relative">
                  <Input label="Password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password" value={password} onChange={e => {
              ...
              <div className="flex justify-end">
                <motion.button type="button" onClick={onForgotPasswordClick} whileHover={{
              scale: 1.02
            }} whileTap={{
              scale: 0.98
            }} className="text-sm text-button-primary hover:text-[#3d9970] hover:underline font-medium transition-colors">
                  Forgot Password?
                </motion.button>
              </div>
          ...
          delay: 0.4
              ...
              <motion.button onClick={onSignupClick} whileHover={{
            scale: 1.05
          }} whileTap={{
            scale: 0.95
